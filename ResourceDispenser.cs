...
public class ResourceDispenser : EntityComponent<BaseEntity>, IServerComponent
{
	...
	public void DoGather(HitInfo info)
	{
		...
		float num = 0f;
		float num2 = 0f;
		BaseMelee baseMelee = (((Object)(object)info.Weapon == (Object)null) ? null : ((Component)info.Weapon).GetComponent<BaseMelee>());
		...
		HitInfo hitInfo = new HitInfo(info.Initiator, base.baseEntity, DamageType.Generic, num4, ((Component)this).get_transform().get_position());
	...
	private void GiveResources(BaseEntity entity, float gatherDamage, float destroyFraction, AttackEntity attackWeapon)
	{
		...
		if (Object.op_Implicit((Object)(object)basePlayer))
		{
			...
			Debug.Assert((Object)(object)ownerPlayer == (Object)(object)basePlayer, string.Concat("Attack Weapon ", attackWeapon, " ownerPlayer is not player"));
