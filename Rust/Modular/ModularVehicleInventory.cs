...
namespace Rust.Modular
{
	public class ModularVehicleInventory : IDisposable
	{
		...
		public bool TrySyncModuleInventory(BaseVehicleModule moduleEntity, int firstSocketIndex)
		{
			...
			{
				Debug.LogError((object)$"{GetType().Name}: Invalid socket index ({firstSocketIndex}) for new module entity.", (Object)(object)((Component)vehicle).get_gameObject());
				return false;
			}
			...
			{
				Debug.LogError((object)$"{GetType().Name}: Sockets are not free for new module entity. First: {firstSocketIndex} Taken: {numSocketsTaken}", (Object)(object)((Component)vehicle).get_gameObject());
				return false;
			}
			if (slot == null)
			{
		...
		private void ModuleItemRemoved(Item moduleItem)
		{
			if (moduleItem == null)
			{
				Debug.LogError((object)"Null module item removed.", (Object)(object)((Component)vehicle).get_gameObject());
				return;
			}
			moduleItem.OnDirty -= OnModuleItemChanged;
			...
			if ((Object)(object)moduleForItem != (Object)null)
			{
				...
				{
					Debug.LogError((object)"Module entity being removed before it's fully spawned. This could cause errors.", (Object)(object)((Component)vehicle).get_gameObject());
				}
				moduleForItem.Kill();
			}
			else
