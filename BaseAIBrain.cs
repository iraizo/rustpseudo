		...
		public override StateStatus StateThink(float delta)
		{
			...
			if (!brain.Navigator.Moving)
			{
				...
				if (currentTargetPoint.WaitTime <= 0f || currentWaitTime >= currentTargetPoint.WaitTime)
				{
					...
					if ((!((Object)(object)currentTargetPoint != (Object)null) || !((Object)(object)currentTargetPoint == (Object)(object)aIMovePoint)) && ((Object)(object)currentTargetPoint == (Object)null || !brain.Navigator.SetDestination(((Component)currentTargetPoint).get_transform().get_position(), BaseNavigator.NavigationSpeed.Slow)))
					{
						return StateStatus.Error;
					}
				}
