...
public class DungeonGridLink : MonoBehaviour
{
	...
	protected void Start()
	{
		...
		{
			DungeonGridInfo dungeonGridInfo = TerrainMeta.Path.FindClosest(TerrainMeta.Path.DungeonGridEntrances, ((Component)this).get_transform().get_position());
			if (!((Object)(object)dungeonGridInfo == (Object)null))
			{
				dungeonGridInfo.Links.Add(((Component)this).get_gameObject());
			}
		}
	}
