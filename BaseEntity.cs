...
public class BaseEntity : BaseNetworkable, IOnParentSpawning, IPrefabPreProcess
{
	...
	public static class Util
	{
		...
		{
			return Enumerable.ToArray<ScientistNPC>(Enumerable.Select<BaseNetworkable, ScientistNPC>(Enumerable.Where<BaseNetworkable>((IEnumerable<BaseNetworkable>)BaseNetworkable.serverEntities, (Func<BaseNetworkable, bool>)((BaseNetworkable x) => (x is ScientistNPC) ? true : false)), (Func<BaseNetworkable, ScientistNPC>)((BaseNetworkable x) => x as ScientistNPC)));
		}
	}
