...
public class TerrainDistanceMap : TerrainMap<byte>
{
	...
	public override void Setup()
	{
		...
		if (((Texture)DistanceTexture).get_width() == ((Texture)DistanceTexture).get_height() && ((Texture)DistanceTexture).get_width() == res)
		{
		...
		{
			Debug.LogError((object)("Invalid distance texture: " + ((Object)DistanceTexture).get_name()), (Object)(object)DistanceTexture);
		}
	}
	...
	public void GenerateTextures()
	{
		...
		((Object)DistanceTexture).set_name("DistanceTexture");
		((Texture)DistanceTexture).set_wrapMode((TextureWrapMode)1);
