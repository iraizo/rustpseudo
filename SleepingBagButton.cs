...
public class SleepingBagButton : MonoBehaviour, IPointerEnterHandler, IEventSystemHandler, IPointerExitHandler
{
	...
	public void DoSpawn()
	{
		...
		if (spawnOption != null)
		{
			ConsoleSystem.Run(Option.get_Client(), "respawn_sleepingbag", new object[1] { spawnOption.id });
		}
	}
	...
	public void DeleteBag()
	{
		...
		if (spawnOption != null)
		{
			ConsoleSystem.Run(Option.get_Client(), "respawn_sleepingbag_remove", new object[1] { spawnOption.id });
		}
	}
