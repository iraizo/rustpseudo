...
public class ElectricGenerator : IOEntity
{
	...
	public override void Save(SaveInfo info)
	{
		...
		if (Object.op_Implicit((Object)(object)component))
		{
			...
			{
				info.msg.puzzleReset.playerDetectionOrigin = component.playerDetectionOrigin.get_position();
			}
	...
	public override void Load(LoadInfo info)
	{
		...
		if ((Object)(object)component != (Object)null)
		{
			...
			if ((Object)(object)component.playerDetectionOrigin != (Object)null)
			{
				component.playerDetectionOrigin.set_position(info.msg.puzzleReset.playerDetectionOrigin);
			}
