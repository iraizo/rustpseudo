...
public class TerrainBiomeMap : TerrainMap<byte>
{
	...
	public override void Setup()
	{
		...
		{
			if (((Texture)BiomeTexture).get_width() == ((Texture)BiomeTexture).get_height())
			{
				res = ((Texture)BiomeTexture).get_width();
				this.num = 4;
			...
			{
				Debug.LogError((object)("Invalid biome texture: " + ((Object)BiomeTexture).get_name()));
			}
		}
		else
		{
	...
	public void GenerateTextures()
	{
		...
		((Object)BiomeTexture).set_name("BiomeTexture");
		((Texture)BiomeTexture).set_wrapMode((TextureWrapMode)1);
