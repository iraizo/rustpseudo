...
public class SpawnPopulation : BaseScriptableObject
{
	...
	public void UpdateWeights(SpawnDistribution distribution, int targetCount)
	{
		...
		for (int i = 0; i < Prefabs.Length; i++)
		{
			...
			int num2 = ((!Object.op_Implicit((Object)(object)prefab.Parameters)) ? 1 : prefab.Parameters.Count);
			num += num2;
		}
		...
		for (int j = 0; j < Prefabs.Length; j++)
		{
			...
			int num4 = ((!Object.op_Implicit((Object)(object)prefab2.Parameters)) ? 1 : prefab2.Parameters.Count);
