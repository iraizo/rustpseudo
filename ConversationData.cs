...
public class ConversationData : ScriptableObject
{
	...
	public class ResponseNode
	{
		...
		public string responseText => responseTextLocalized.get_translated();
	...
	public class SpeechNode
	{
		...
		public string statement => statementLocalized.get_translated();
	}
	...
	public string providerName => providerNameTranslated.get_translated();
