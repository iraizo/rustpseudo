...
public class Socket_Free : Socket_Base
{
	...
	private void OnDrawGizmosSelected()
	{
		...
		Gizmos.DrawLine(Vector3.get_zero(), Vector3.get_forward() * 1f);
		GizmosUtil.DrawWireCircleZ(Vector3.get_forward() * 0f, 0.2f);
	...
	public override Construction.Placement DoPlacement(Construction.Target target)
	{
		...
		if (useTargetNormal)
		{
			if (blendAimAngle)
			{
				val = target.position - ((Ray)(ref target.ray)).get_origin();
