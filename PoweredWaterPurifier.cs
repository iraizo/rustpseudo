	...
	protected override void SpawnStorageEnt(bool load)
	{
		...
		if (load)
		{
			foreach (BaseEntity child in children)
			{
				...
				if ((liquidContainer = child as LiquidContainer) != null)
				{
		...
		waterStorage = GameManager.server.CreateEntity(storagePrefab.resourcePath, storagePrefabAnchor.get_position(), storagePrefabAnchor.get_rotation()) as LiquidContainer;
