...
public class IOEntityMovementChecker : FacepunchBehaviour
{
	...
	private void CheckPosition()
	{
		...
		if (!ioEntity.isClient && Vector3.SqrMagnitude(((Component)this).get_transform().get_position() - prevPos) > 0.0025000002f)
		{
			prevPos = ((Component)this).get_transform().get_position();
	...
	public IOEntityMovementChecker()
		: this()
	{
	}
}
