...
public class Cassette : BaseEntity
{
	...
	public static void ClearCassettes(Arg arg)
	{
		...
		try
		{
			...
			{
				Cassette cassette;
				if ((cassette = enumerator.get_Current() as Cassette) != null && cassette.ClearSavedAudio())
				{
					num++;
				}
			}
	...
	public static void ClearCassettesByUser(Arg arg)
	{
		...
		try
		{
			...
			{
				Cassette cassette;
				if ((cassette = enumerator.get_Current() as Cassette) != null && cassette.CreatorSteamId == uInt)
				{
