...
public class PerformedAttackAIEvent : BaseAIEvent
{
	...
	public override void Execute(AIMemory memory, AIBrainSenses senses, StateStatus stateStatus)
	{
		...
		if (combatEntity.lastDealtDamageTime >= num)
		{
			...
			if (!((Object)(object)basePlayer != (Object)null) || ((!((Object)(object)basePlayer == (Object)(object)memory.Entity.Get(5)) || !((Object)(object)basePlayer.lastDealtDamageTo == (Object)(object)base.Owner)) && (!((Object)(object)basePlayer == (Object)(object)memory.Entity.Get(5)) || (((Component)basePlayer.lastDealtDamageTo).get_gameObject().get_layer() != 21 && ((Component)basePlayer.lastDealtDamageTo).get_gameObject().get_layer() != 8))))
			{
