...
public class TerrainAlphaMap : TerrainMap<byte>
{
	...
	public override void Setup()
	{
		...
		{
			if (((Texture)AlphaTexture).get_width() == ((Texture)AlphaTexture).get_height())
			{
				res = ((Texture)AlphaTexture).get_width();
			...
			{
				Debug.LogError((object)("Invalid alpha texture: " + ((Object)AlphaTexture).get_name()));
			}
			return;
		}
	...
	public void GenerateTextures()
	{
		...
		((Object)AlphaTexture).set_name("AlphaTexture");
		((Texture)AlphaTexture).set_wrapMode((TextureWrapMode)1);
